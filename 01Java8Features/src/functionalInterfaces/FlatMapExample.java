...
public class FlatMapExample {
	...
	public static void main(String[] args) {
		...
		List<Employee> list1 = Arrays.asList(new Employee("A121", "Madhu", "Hyd", 30000.0),
				new Employee("A123", "Manu", "Ban", 50000.0));

		List<Employee> list2 = Arrays.asList(new Employee("B121", "Madhu", "Hyd", 30000.0),
				new Employee("B123", "Manu", "Ban", 50000.0));

		List<Employee> list3 = Arrays.asList(new Employee("C121", "Madhu", "Hyd", 30000.0),
